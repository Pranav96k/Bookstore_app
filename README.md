...
Start the Next.js frontend and the Flask API.
...
## Button-Like Styling for "Paid" or "Free"
We wrap the isPaid text inside a span element and apply Tailwind CSS classes to style it as a small button.
